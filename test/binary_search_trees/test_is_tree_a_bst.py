#!/usr/bin/env python3
from src.binary_search_trees.is_tree_a_bst import is_binary_tree_bst
from src.binary_trees.binary_tree import BinaryTreeNode


def test_is_binary_tree_bst0() -> None:
...
def test_is_binary_tree_bst1() -> None:
    # Construct binary tree.
...
def test_is_binary_tree_bst2() -> None:
    # Construct binary tree.
    E = BinaryTreeNode(data=0)
